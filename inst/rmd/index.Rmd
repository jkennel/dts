...
dts <- read_dts_xml('/home/jonathankennel/Storage/data/dts/gdc_05_2015-11-02/2015-11-02 Active DTS Test GDC-05 7_5 W per m/', n_cores = 14) %>%
  dts_to_long()
...
plot_group <- function(x, group = 6, n_trim = 1) {
